 ...
 *
 * <p>Set {@code app.mqtt.enabled=true} (or env {@code APP_MQTT_ENABLED=true})
...
public record MqttProperties(
         ...
         * </ul>
         */
        @DefaultValue("smartrh/attendance/recognition,smartrh/attendance/raw,smartrh/system/heartbeat")
        String[] topics,

        /** QoS level for all subscriptions: 0 at-most-once, 1 at-least-once, 2 exactly-once. */
